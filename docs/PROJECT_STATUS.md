...
- Current production issue: None known; #50 is a visibility-only reduction pending review, with CEO-facing naming, one fast-loading top-level Management readout instead of duplicate KPIs (including minutes and operating cost), consistent first-load header chips without a Source label, bottom-positioned metric definitions, expanded sidebar navigation, polished Follow-up/Repeat engagement cards with normalized phone totals that match their profile drawers, factual Ledger follow-up, repeat, call-cost, and cumulative-lead-cost sorting with lead-level inbound/outbound mix and billed-minute context, streamlined profile drawers with inbound/outbound mix and collapsed long histories, standardized record-level CSV exports with call and lead total cost, compact failure reasons, and an action-oriented Requested follow-ups view with visibly active readiness filters. The initial-render KPI-container regression has been fixed on the branch and requires deployment review.
